                    ...
                    <script type="text/javascript">
                        var vectorLayer = new ol.layer.Vector({
                            source: new ol.source.Vector({
                                ...
                                url: '<?php echo base_url() ?>assets/data/harmonis.json' //url ini digunakan untuk mengambil data drainase
                            }),
                        ...
                        var vectorLayer4 = new ol.layer.Vector({
                            source: new ol.source.Vector({
                                format: new ol.format.GeoJSON(),
                                url: '<?php echo base_url() ?>assets/data/jalanharmonis.json' //digunakan untuk mengambil data yang telah dibuat polygon.
                            }),
                        });
