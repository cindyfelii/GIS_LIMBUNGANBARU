                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href=<?= site_url('home/listing') ?>>Map</a></li>
                                <li><a href="#">Pages</a>
                                    <ul class="dropdown">
                    ...
                    <script type="text/javascript">
                        var vectorLayer = new ol.layer.Vector({
                            source: new ol.source.Vector({
                                ...
                                url: '<?php echo base_url() ?>assets/data/pembangunan.json' //url ini digunakan untuk mengambil data drainase
                            }),
                        ...
                        var vectorLayer4 = new ol.layer.Vector({
                            source: new ol.source.Vector({
                                format: new ol.format.GeoJSON(),
                                url: '<?php echo base_url() ?>assets/data/jalanpembangunan.json' //digunakan untuk mengambil data yang telah dibuat polygon.
                            }),
                        });
                        ...
                        var map = new ol.Map({
                            ...
                            layers: [
                                ...
                                }), vectorLayer4, vectorLayer //digunakan untuk menampilkan hasil
                            ],
                            view: new ol.View({
                    ...
                    <script type="text/javascript">
                        ...
                        map.on('click', function(evt) {
                            ...
                            if (feature) { // untuk cek feature jalan atau tidak
                                ...
                                var content = '<h5><strong>Nama Jalan : ' + feature.get('Nama_Jalan') + '</strong></h5>'; //untuk menampilkan Nama Jalan yang diambil dari variabel Nama_Jalan_Banjir
