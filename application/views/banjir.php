                    ...
                    <script type="text/javascript">
                        ...
                        var map = new ol.Map({
                            ...
                            layers: [
                                ...
                                }), vectorLayer4, vectorLayer2 //digunakan untuk menampilkan hasil
                            ],
                            view: new ol.View({
                    ...
                    <script type="text/javascript">
                        ...
                        map.on('click', function(evt) {
                            ...
                            if (feature) { // untuk cek feature jalan atau tidak
                                ...
                                var content = '<h5><strong>Nama Jalan : ' + feature.get('Nama_Jalan_Banjir') + '</strong></h5>'; //untuk menampilkan Nama Jalan yang diambil dari variabel Nama_Jalan_Banjir
                                content += '<h6>Kondisi Kerusakan : ' + feature.get('Kondisi_Kerusakan') + '</h6>'; //untuk menampilkan Kondisi Kerusakan yang diambil dari variabel Kondisi_Kerusakan
