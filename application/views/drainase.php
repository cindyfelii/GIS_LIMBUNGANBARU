                    ...
                    <script type="text/javascript">
                        ...
                        var map = new ol.Map({
                            ...
                            layers: [
                                ...
                                }), vectorLayer, vectorLayer4 //digunakan untuk menampilkan hasil
                            ],
                            view: new ol.View({
                    ...
                    <script type="text/javascript">
                        ...
                        map.on('click', function(evt) {
                            ...
                            if (feature) { // untuk cek feature jalan atau tidak
                                ...
                                var content = '<h5><strong>Nama Jalan : ' + feature.get('Nama_Jalan') +
                                    '</strong></h5>'; //untuk menampilkan nama jalan yang diambil dari variabel Nama_Jalan
                                content += '<h6>Lebar : ' + feature.get('Lebar') +
                                    '</h6>'; //untuk menampilkan Lebar yang diambil dari variabel Lebar
                                content += '<h6>Kedalaman : ' + feature.get('Kedalaman') +
                                    '</h6>'; //untuk menampilkan Kedalaman yang diambil dari variabel Kedalaman
                                content += '<h6>Kondisi : ' + feature.get('Kondisi') +
                                    '</h6>'; //untuk menampilkan Kondisi yang diambil dari variabel Kondisi
                                content += '<h6>Bahan : ' + feature.get('Bahan') +
                                    '</h6>'; //untuk menampilkan Bahan yang diambil dari variabel Bahan
                                content += '<h6>Arah Alir : ' + feature.get('Arah_Air') +
                                    '</h6>'; //untuk menampilkan Arah Alir yang diambil dari variabel Arah_Air
